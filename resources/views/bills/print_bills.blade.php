                ...
                <div class="card card-bill">
                    <div class="card-body">
                        <div class="bill-header">
                            <h1 class="bill-title">فاتورة تحصيل</h1>
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                ...
                                <p class="bill-info-row"><span>رقم الفاتورة</span>
                                    <span>{{ $bills->bill_number }}</span></p>
                                <p class="bill-info-row"><span>تاريخ الاصدار</span>
                                    <span>{{ $bills->bill_Date }}</span></p>
                                <p class="bill-info-row"><span>تاريخ الاستحقاق</span>
                                    <span>{{ $bills->Due_date }}</span></p>
                                <p class="bill-info-row"><span>القسم</span>
                                    <span>{{ $bills->section->section_name }}</span></p>
                            </div>
                        </div>
                        <div class="table-responsive mg-t-40">
                            <table class="table table-bill border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="tx-right">نسبة الضريبة ({{ $bills->Rate_VAT }})</td>
