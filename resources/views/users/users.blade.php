...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الاعدادات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ المستخدمين</span>
            </div>
        </div>
                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale"
                           data-toggle="modal" href="#modaldemo8">اضافة مستخدم</a>
                ...
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('users.store') }}" method="post">
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">البريد الالكترونى</label>
                                <input type="email" class="form-control" id="email" name="email" rows="3">
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">كلمة المرور</label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="users/update" method="post" autocomplete="off">
                            ...
                            <div class="form-group">
                                <label for="message-text" class="col-form-label">البريد الالكترونى:</label>
