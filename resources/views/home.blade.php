                        ...
                        <div class="d-flex">
                            <div class="">
                                <h3 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format(\App\Models\Bill::where('Value_Status', 2)->sum('Total'), 2) }}

                                </h3>
                                <p class="mb-0 tx-12 text-white op-7">{{ \App\Models\Bill::where('Value_Status', 2)->count() }}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                ...
                                <span class="text-white op-7">
                                    ...
                                    if($count_bills2 == 0){
                                       echo $count_bills2 = 0;
                                        ...
                                        $count_bills2 = $count_bills2 / $count_all *100;
                                    }
                                    @endphp
                                     % {{ round( $count_bills2 ) }}
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format(\App\Models\Bill::where('Value_Status', 1)->sum('Total'), 2) }}

                                </h4>
                                <p class="mb-0 tx-12 text-white op-7">
                                    {{ \App\Models\Bill::where('Value_Status', 1)->count() }}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-up text-white"></i>
                                    ...
                                    @php
                                        ...
                                        if($count_bills1 == 0){
                                           echo $count_bills1 = 0;
                                            ...
                                            $count_bills1 = $count_bills1 / $count_all *100;
                                        }
                                    @endphp
                                    % {{ round( $count_bills1 ) }}
                                </span>
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format(\App\Models\Bill::where('Value_Status', 3)->sum('Total'), 2) }}

                                </h4>
                                <p class="mb-0 tx-12 text-white op-7">
                                    {{\App\Models\Bill::where('Value_Status', 3)->count() }}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-down text-white"></i>
                                <span class="text-white op-7">
                                    ...
                                    @php
                                        $count_all= \App\Models\Bill::count();
                                        $count_bills1 = \App\Models\Bill::where('Value_Status', 3)->count();
